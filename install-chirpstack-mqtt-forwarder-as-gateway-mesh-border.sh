...
script_to_run="/opt/awesome_linxdot/run_chirpstack_mqtt_forwarder_as_gateway_mesh_boarder.sh"
...
start_service() {
    ...
    procd_open_instance
    procd_set_param command /opt/awesome_linxdot/run_chirpstack_mqtt_forwarder_as_gateway_mesh_boarder.sh
