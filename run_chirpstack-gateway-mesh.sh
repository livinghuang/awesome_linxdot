...
cd /opt/awesome_linxdot/chirpstack-software/chirpstack-gateway-mesh-binary
#./chirpstack-gateway-mesh -c ./config/chirpstack-gateway-mesh.toml -c ./config/region_$region.toml > /var/log/gateway_mesh.log 2>&1 &

 while [ true ]; do

     ./chirpstack-gateway-mesh -c ./config/chirpstack-gateway-mesh.toml -c ./config/region_$region.toml | logger -t chirpstack-gateway-mesh
